...
#SBATCH --output=/home/zwangot/stag_unet/logs/attunet_v9_%j.log
#SBATCH --error=/home/zwangot/stag_unet/logs/attunet_v9_%j.err
...
echo "=============================="
echo "Attention U-Net v9 baseline (stable)"
echo "Date: $(date)"
echo "Host: $(hostname)"
echo "Repo: $REPO_ROOT"
echo "Data: $DATA_DIR"
...
echo "Attention U-Net v9 baseline finished at $(date)"
